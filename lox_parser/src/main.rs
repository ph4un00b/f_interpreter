    ...
    fn resolve(&mut self, val: Expr) {
        match val.clone() {
            ...
            Expr::Super {
                ...
                match self.current_row_type {
                    RowType::None => {
                        panic!("Can't use '{}' outside of a Row.", String::from(Tk::Super))
                    }
                    RowType::Row => {
                        panic!("Can't use '{}' from a simple Row.", String::from(Tk::Super))
                    }
                    RowType::SubRow => (),
                }
        ...
        match val.clone() {
            Statement::Row {
                ...
                match &super_expr {
                     ...
                     */
                    _ => {
                        self.current_row_type = RowType::SubRow;
                        self.resolve(super_expr.clone())
                    }
                }
...
mod tests {
    ...
    #[test]
    #[should_panic = "Can't use 'super' outside of a Row."]
    fn test_invalid_super_2() {
        let tokens = vec![
            //? super.notEvenInAClass();
            Tk::Super,
            Tk::Dot,
            Tk::Identifier("notEvenInAClass".into(), 1),
            Tk::Lpar,
            Tk::Rpar,
            Tk::Semi,
            Tk::End,
    ...
    #[test]
    #[should_panic = "Can't use 'super' from a simple Row."]
    fn test_invalid_super() {
        //?1 class Eclair {
        //?2     cook() {
        //?3       super.cook();
        //?4       print 42;
